...
const HouseEvalSchema = require("./schema/house/HouseEvaluationSchema");
class HouseEvalModel extends baseModel {
  constructor() {
    super("evaluations", HouseEvalSchema);
  }
  // 查询单条数据
  FindOne(filter = {}) {
    let filterData = {
...
module.exports = new HouseEvalModel();
