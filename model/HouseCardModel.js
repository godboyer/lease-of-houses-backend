...
const HouseCardSchema = require('./schema/house/HouseCardSchema')


class HouseCardModel extends BaseModel {
    constructor() {
        super('houseonecards', HouseCardSchema)
    }
...
module.exports = new HouseCardModel()
